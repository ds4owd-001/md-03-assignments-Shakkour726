...
1.  Look at the plot that you created. What do you notice about the order of the bars / order of the legend? the other way around
2.  What would you want to change? change the order
3.  Why did we remove "safely managed sanitation services" from the data set in Task 3? some countries do not have an estimate for sms
